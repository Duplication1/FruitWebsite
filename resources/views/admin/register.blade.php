<x-admin-layout>
    <form class="mx-auto bg-green-500  w-4/5  sm:w-3/5 md:w-1/3 flex flex-col p-5 gap-5" method="POST" action="/admin/register">
        @csrf
        <h1 class="text-2xl font-bold text-green-900 text-center">Admin Register</h1>
